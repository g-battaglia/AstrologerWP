<?php
/**
 * SolarReturnChartController — REST endpoint for solar return chart calculations.
 *
...
/**
 * Handles POST /astrologer/v1/solar-return-chart.
 *
 * Calculates the chart for when the transiting Sun returns to its exact
 * natal longitude for a given year.
 */
final class SolarReturnChartController extends AbstractController {
	...
	/**
	 * Register the solar return chart route.
	 */
	...
	/**
	 * Handle the solar return chart request.
	 *
	...
	public function handle( WP_REST_Request $request ): WP_REST_Response {
		...
		$result = $this->chart_service->solarReturnChart( $dto );
	...
	private function get_args(): array {
		...
		$extra = array(
			...
			'year'            => array(
				'description'       => __( 'Target year for the solar return.', 'astrologer-api' ),
				'type'              => 'integer',
				'required'          => true,
				'minimum'           => 1,
				'maximum'           => 3000,
