<?php
/**
 * SynastryAspectsController — REST endpoint for synastry aspect data.
 *
...
/**
 * Handles POST /astrologer/v1/synastry-aspects.
 *
 * Accepts two subjects, proxies to ChartService::synastryChartData(),
 * returns inter-chart aspect data without SVG rendering.
 */
final class SynastryAspectsController extends AbstractController {
	...
	/**
	 * Register the synastry aspects route.
	 */
	...
	/**
	 * Handle the synastry aspects request.
	 *
	...
	public function handle( WP_REST_Request $request ): WP_REST_Response {
		...
		$result = $this->chart_service->synastryChartData( $dto );
