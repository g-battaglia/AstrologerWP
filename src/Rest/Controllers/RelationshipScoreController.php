<?php
/**
 * RelationshipScoreController — REST endpoint for Ciro Discepolo compatibility score.
 *
...
/**
 * Handles POST /astrologer/v1/relationship-score.
 *
 * Accepts two subjects, proxies to ChartService::compatibilityScore(),
 * returns a numeric compatibility score with textual description.
 */
final class RelationshipScoreController extends AbstractController {
	...
	/**
	 * Register the relationship score route.
	 */
	...
	/**
	 * Handle the relationship score request.
	 *
	...
	public function handle( WP_REST_Request $request ): WP_REST_Response {
		...
		$dto    = CompatibilityRequestDTO::from_array( $params );

		$result = $this->chart_service->compatibilityScore( $dto );
