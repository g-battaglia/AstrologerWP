<?php
/**
 * NatalChartController — REST endpoint for natal chart calculations.
 *
...
/**
 * Handles POST /astrologer/v1/natal-chart.
 *
 * Accepts a single subject with optional chart options, proxies the request
 * to ChartService::birthChart(), and returns the chart data with SVG.
 */
final class NatalChartController extends AbstractController {
	...
	/**
	 * Register the natal chart route.
	 */
	...
	/**
	 * Handle the natal chart request.
	 *
	...
	private function get_args(): array {
		...
		// Subject fields are nested under 'subject' key.
		$nested = array();
