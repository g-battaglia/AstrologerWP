...
const synastryAttributes = {
    // Reuse same attributes structure as synastry
...
registerBlockType('astrologer-api/compatibility-chart', {
    title: 'Compatibility Score',
    description: 'Displays the compatibility score between two subjects.',
    icon: HeartIcon,
    category: 'astrology',
