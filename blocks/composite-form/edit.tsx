...
const LAYOUTS = [
	{ label: __( 'Stacked', 'astrologer-api' ), value: 'stacked' },
	{ label: __( 'Side by side', 'astrologer-api' ), value: 'side-by-side' },
];
		...
		<>
			<InspectorControls>
				<PanelBody title={ __( 'Form Settings', 'astrologer-api' ) }>
					...
					/>
					<SelectControl
						label={ __( 'Two-Subject Layout', 'astrologer-api' ) }
						value={ twoSubjectLayout }
						options={ LAYOUTS }
						onChange={ ( val: string ) =>
							setAttributes( { twoSubjectLayout: val } )
						}
					/>
					<ToggleControl
			...
			<div { ...blockProps }>
				...
				>
					<p style={ { margin: 0, fontWeight: 600 } }>
						{ __( 'Composite Form', 'astrologer-api' ) }
					</p>
