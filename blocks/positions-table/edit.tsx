...
const DISPLAY_MODES = [
	{ label: __( 'Table', 'astrologer-api' ), value: 'table' },
	{ label: __( 'Compact', 'astrologer-api' ), value: 'compact' },
];
...
export default function Edit( { attributes, setAttributes }: Props ) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={ __( 'Positions Table Settings', 'astrologer-api' ) }
				>
					<SelectControl
			...
			<div { ...blockProps }>
				...
				>
					<p style={ { margin: 0, fontWeight: 600 } }>
						{ __( 'Positions Table', 'astrologer-api' ) }
					</p>
